...
from memory.id_utils import new_uuid
from memory.models.fact_models import EventRecord, EventType
from memory.ddb_client import USER_EVENT_TABLE, get_ddb_resource
